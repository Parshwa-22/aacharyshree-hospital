...
export default function DoctorProfileCard({ doctor, specialization, department, appointmentPhone }) {
  ...
  return (
    <article className="flex h-full min-h-[650px] min-w-0 flex-col overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl">
